  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <input type="hidden" class="form-control " id="id" name="id" placeholder="Input Nomor Dokumen" value="<?=$id?>">
        ...
        <div class="form-group ">
            <label for="deskripsi" class="form-label">Revisi</label>
            <input type="text" class="form-control " id="revisi" name="revisi" placeholder="Input Deskripsi" value="<?=$revisi_dokumen;?>" readonly>
