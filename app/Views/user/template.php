     ...
     <!--  <div class="form-inline">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/user/dokumen" class="nav-link">
            ...
            <!-- <i class="far fa-circle nav-icon"></i> -->
              ...
              <li class="nav-item">
                <a href="/user/rekaman" class="nav-link">
            ...
            <!-- <i class="far fa-circle nav-icon"></i> -->
              ...
              <li class="nav-item">
                <a href="/user/perizinan" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/user/apd" class="nav-link">
        ...
        <li class="nav-header">What's On !</li>
          ...
          <li class="nav-item">
            <a href="/user/kegiatan" class="nav-link">
