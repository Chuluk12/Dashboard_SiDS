        ...
        <div class="row">
          <div class="col-lg-4 col-5">
            ...
            <div class="small-box bg-primary">
              ...
              <a href="/admin/dokumen" class="small-box-footer">Lihat ! <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-5">
            ...
            <div class="small-box bg-secondary">
              ...
              <a href="/admin/rekaman" class="small-box-footer">Lihat ! <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-5">
            ...
            <div class="small-box bg-success">
              ...
              <a href="/admin/perizinan" class="small-box-footer">Lihat ! <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="col-lg-4 col-5">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="/admin/patrol" class="small-box-footer">Lihat ! <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-5">
            ...
            <div class="small-box bg-info">
              ...
              <a href="/admin/apd" class="small-box-footer">Lihat ! <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
           <!-- ./col -->
        </div>
