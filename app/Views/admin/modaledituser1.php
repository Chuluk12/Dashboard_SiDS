  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Data Perubahan Karyawan</h5>
      ...
      <div class="modal-body">
            <input type="hidden" class="form-control" name="id" id="id" placeholder="Masukan Nama Depan" value="<?=$kd_user?>">
        <div class="form-group">
          <div class="form-row">
            <div class="col">
            <label for="id_karyawan">ID Pengguna</label>
            <input type="text" class="form-control" name="id_karyawan" id="id_karyawan" placeholder="Masukan ID Karyawan" value="<?= $id_karyawan;?>" readonly>
