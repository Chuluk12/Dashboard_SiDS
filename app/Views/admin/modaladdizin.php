<!-- Modal -->
<div class="modal fade" id="modaladdizin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Data Dokumen Perizinan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <?= form_open_multipart('', ['class' => 'formaddizin']) ?>
      <?= csrf_field(); ?>
      <div class="modal-body">
      <div class="form-group ">
        <div class="form-row">
          <div class="col">
        <label for="pilih_kt" >Kategori Perizinan</label>
          <select class="custom-select" id="pilih_kt" name="pilih_kt" value="">
          <option selected disabled value=""  >Pilih Kategori</option>
          <option value="Perizinan">Perizinan</option>
          <option value="Non Perizinan">Non Perizinan</option>
          </select>
        ...
        <div class="col">
            ...
            <input type="text" class="form-control " id="no_izin" name="no_izin" placeholder="Input Nomor Perizinan" >
        ...
        <div class="col">
            ...
            <input type="date" class="form-control" id="tgl_masa" name="tgl_masa"  >
...
<script>
    $(document).ready(function(){
        $('.btnaddsimpan').click(function(e){
            e.preventDefault();
            let form = $('.formaddizin')[0];

            let data = new FormData(form);

            $.ajax({
                type: "post",
                url:'/admin/simpanaddizin',
                data: data,
